        ...
        <div class="container-custom">
            ...
            @if($division->products->count() > 0)
                <div class="mb-16">
                    ...
                    <div class="{{ $division->products->count() === 1 ? 'flex justify-center max-w-sm mx-auto' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6' }}">
            ...
            @if($division->technologies->count() > 0)
                <div class="mb-16">
                    ...
                    <div class="{{ $division->technologies->count() === 1 ? 'flex justify-center max-w-sm mx-auto' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6' }}">
            ...
            @if($division->machines->count() > 0)
                <div class="mb-16">
                    ...
                    <div class="{{ $division->machines->count() === 1 ? 'flex justify-center max-w-sm mx-auto' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6' }}">
