...
<head>
    ...
    <title>Server Error - {{ \App\Models\Setting::getValue('company_name', 'Company') }}</title>
    <meta name="description" content="We are experiencing technical difficulties. Please try again later.">
        ...
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    We are experiencing technical difficulties. Our team has been notified and is working to resolve the issue.
                </p>
