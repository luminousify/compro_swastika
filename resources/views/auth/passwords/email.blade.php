...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-xl shadow-xl p-8 border border-gray-100">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Enter your email address and we'll send you a secure password reset link.</p>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-200 text-center">
            <a href="{{ route('login') }}" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-500 transition-colors">
