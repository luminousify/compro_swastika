...
<li class="flex items-center">
    ...
    <span class="ml-4 text-sm font-medium text-gray-900">Create Machine</span>
</li>
@endsection
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Create a new machine for the <strong>{{ $division->name }}</strong> division.
                    </p>
                </div>
            </div>
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <form method="POST" action="{{ route('admin.machines.store', $division) }}" class="space-y-6" novalidate enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-100">
                        <div class="px-6 py-8 space-y-8">
                            ...
                            <!-- Machine Images -->
                            <div class="form-group">
                                <label for="images" class="form-label">Machine Images</label>
                                ...
                                <div id="images-help" class="form-help">
                                    Upload multiple images to showcase this machine. Images will be displayed in the machine section.
                                </div>
                                @error('images')
