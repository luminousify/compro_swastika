            ...
            @foreach($media as $item)
                <div class="swiper-slide">
                    <div class="relative w-full max-w-3xl mx-auto overflow-hidden rounded-xl bg-black shadow-lg">
                        ...
                        <div class="aspect-[16/9.5] sm:aspect-[4/3.15] lg:aspect-[16/9.5]">
                            <img src="{{ $item->url }}" 
...
<div class="no-images-placeholder mb-8">
    <div class="max-w-3xl mx-auto aspect-[16/9.5] sm:aspect-[4/3.15] lg:aspect-[16/9.5] bg-gray-50 rounded-xl border-2 border-dashed border-gray-200 flex items-center justify-center">
