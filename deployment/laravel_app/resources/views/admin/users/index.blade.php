...
<li class="flex items-center">
    ...
    <span class="ml-4 text-sm font-medium text-gray-900">Users</span>
</li>
@endsection
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div class="mb-6 bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <form method="GET" action="{{ route('admin.users.index') }}" class="sm:flex sm:items-center sm:space-x-4">
                    <div class="flex-1">
                    ...
                    <div class="mt-3 sm:mt-0">
                        ...
                        <select name="role" id="role" class="block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
