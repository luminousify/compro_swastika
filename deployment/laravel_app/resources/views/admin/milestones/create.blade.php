            ...
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Add a significant event or achievement in your company's history.
                    </p>
...
<script>
// Simple rich text helper
document.addEventListener('DOMContentLoaded', function() {
    const textarea = document.getElementById('text');
    
    // Add some basic formatting buttons if needed
    // For now, we'll let users input HTML directly
});
</script>
@endsection